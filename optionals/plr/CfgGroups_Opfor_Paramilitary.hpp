...
class TACU_PLR_G_O_Infantry_Paramilitary {
    ...
    class TACU_PLR_G_O_Infantry_Paramilitary_Fireteam: TACU_PLR_G_O_Infantry_Paramilitary_Patrol {
        name = "Fireteam";
        class unit0 {
            vehicle = "TACU_PLR_U_O_Paramilitary_TeamLeader";
            side = 0;
    ...
    class TACU_PLR_G_O_Infantry_Paramilitary_Squad: TACU_PLR_G_O_Infantry_Paramilitary_Fireteam {
        name = "Squad";
        class unit0 {
            vehicle = "TACU_PLR_U_O_Paramilitary_TeamLeader";
            side = 0;
