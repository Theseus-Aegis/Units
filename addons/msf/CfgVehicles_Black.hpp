...
class TACU_MSF_V_I_Prowler_Black: B_LSV_01_unarmed_F {
    dlc = QUOTE(PREFIX);
    MACRO_CLEAR_VEHICLE_CARGO
    faction = "TACU_MSF_I";
    side = 2;
...
class TACU_MSF_V_I_Prowler_HMG_Black: B_LSV_01_armed_F {
    dlc = QUOTE(PREFIX);
    MACRO_CLEAR_VEHICLE_CARGO
    faction = "TACU_MSF_I";
    side = 2;
...
class TACU_MSF_V_I_Prowler_AT_Black: B_LSV_01_AT_F {
    dlc = QUOTE(PREFIX);
    MACRO_CLEAR_VEHICLE_CARGO
    faction = "TACU_MSF_I";
    side = 2;
