// Boats
class TACU_Foreign_Legion_V_B_Assault_Boat: TACU_Assault_Boat_Base {
...
// Cars
class TACU_Foreign_Legion_V_B_MATV: TACU_MATV_Unarmed_Base {
    MACRO_FACTION_VEHICLE_DEFAULTS;
    faction = "TACU_Foreign_Legion_B";
    side = 1;
    crew = "TACU_Foreign_Legion_U_B_Driver";
...
// Helicopters
class TACU_Foreign_Legion_V_B_Little_Bird: TACU_AH6_LittleBird_Base {
    MACRO_FACTION_VEHICLE_DEFAULTS;
    faction = "TACU_Foreign_Legion_B";
    side = 1;
...
// APCs
class TACU_Foreign_Legion_V_B_Pandur: TACU_Pandur_Base {
    MACRO_FACTION_VEHICLE_DEFAULTS;
    faction = "TACU_Foreign_Legion_B";
    side = 1;
    crew = "TACU_Foreign_Legion_U_B_Driver";
