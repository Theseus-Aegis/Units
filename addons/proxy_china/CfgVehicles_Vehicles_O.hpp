// Boats
class TACU_Proxy_China_V_O_Assault_Boat: TACU_Assault_Boat_Base {
...
// Anti-Air
class TACU_Proxy_China_V_O_Tigris: TACU_Tigris_Base {
    MACRO_FACTION_VEHICLE_DEFAULTS;
    faction = "TACU_Proxy_China_O";
    side = 0;
    crew = "TACU_Proxy_China_U_O_Driver";
...
// APCs
class TACU_Proxy_China_V_O_BM2T_Stalker: TACU_BM2T_Stalker_Base {
    MACRO_FACTION_VEHICLE_DEFAULTS;
    faction = "TACU_Proxy_China_O";
    side = 0;
    crew = "TACU_Proxy_China_U_O_Driver";
...
// Cars
class TACU_Proxy_China_V_O_Karatel: TACU_Karatel_Unarmed_Base {
    MACRO_FACTION_VEHICLE_DEFAULTS;
    faction = "TACU_Proxy_China_O";
    side = 0;
    crew = "TACU_Proxy_China_U_O_Driver";
...
// Helicopters
class TACU_Proxy_China_V_O_Kasatka_Unarmed: TACU_Kasatka_Unarmed_Base {
    MACRO_FACTION_VEHICLE_DEFAULTS;
    faction = "TACU_Proxy_China_O";
    side = 0;
