...
class I_C_Soldier_Para_2_F: I_C_Soldier_base_F {
    magazines[] = {mag_6("tacgt_AI_30Rnd_762x39_AK"), mag_3("10Rnd_9x21_Mag"), mag_2("HandGrenade")};
};

class I_C_Soldier_Para_3_F: I_C_Soldier_base_F {
    magazines[] = {"tacgt_AI_30Rnd_762x39_AK", "tacgt_AI_30Rnd_762x39_AK"};
};

class I_C_Soldier_Para_4_F: I_C_Soldier_base_F {
    magazines[] = {mag_3("tacgt_AI_200Rnd_556x45_Box"), mag_3("10Rnd_9x21_Mag")};
};

class I_C_Soldier_Para_5_F: I_C_Soldier_base_F {
    magazines[] = {"tacgt_AI_30Rnd_545x39_AK", "tacgt_AI_30Rnd_545x39_AK", "RPG7_F"};
};

class I_C_Soldier_Para_6_F: I_C_Soldier_base_F {
    magazines[] = {mag_6("tacgt_AI_30Rnd_762x39_AK"), mag_5("1Rnd_HE_Grenade_shell")};
};
...
class I_C_Soldier_Para_8_F: I_C_Soldier_base_F {
    magazines[] = {mag_2("tacgt_AI_30Rnd_545x39_AK")};
};
...
class I_C_Soldier_Bandit_2_F: I_C_Soldier_base_F {
    magazines[] = {mag_2("tacgt_AI_30Rnd_545x39_AK"), "RPG7_F"};
};

class I_C_Soldier_Bandit_3_F: I_C_Soldier_base_F {
    magazines[] = {"tacgt_AI_200Rnd_556x45_Box", mag_3("10Rnd_9x21_Mag")};
};
...
class I_C_Soldier_Bandit_7_F: I_C_Soldier_base_F {
    magazines[] = {mag_6("tacgt_AI_30Rnd_545x39_AK"), mag_2("MiniGrenade")};
};

class I_C_Soldier_Bandit_8_F: I_C_Soldier_base_F {
    magazines[] = {mag_2("tacgt_AI_30Rnd_545x39_AK") mag_2("MiniGrenade")};
};
