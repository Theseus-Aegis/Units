// Units - National Party of Chernarus
...
class CUP_I_GUE_Soldier_AKM: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_6("TACU_Magazine_30Rnd_762_AK"), mag_2("HandGrenade")};
    respawnMagazines[] = {mag_6("TACU_Magazine_30Rnd_762_AK"), mag_2("HandGrenade")};
};
...
class CUP_I_GUE_Soldier_LAT: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_6("TACU_Magazine_30Rnd_762_AK"), mag_2("HandGrenade"), "CUP_RPG18_M"};
    respawnMagazines[] = {mag_6("TACU_Magazine_30Rnd_762_AK"), mag_2("HandGrenade"), "CUP_RPG18_M"};
};
class CUP_I_GUE_Soldier_GL: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_6("TACU_Magazine_30Rnd_545_AK"), mag_6("CUP_1Rnd_HE_GP25_M")};
    respawnMagazines[] = {mag_6("TACU_Magazine_30Rnd_545_AK"), mag_6("CUP_1Rnd_HE_GP25_M")};
};
...
class CUP_I_GUE_Soldier_AT: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_4("TACU_Magazine_30Rnd_762_AK"), "CUP_PG7VL_M"};
    respawnMagazines[] = {mag_4("TACU_Magazine_30Rnd_762_AK"), "CUP_PG7VL_M"};
};
class CUP_I_GUE_Soldier_AA: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_4("TACU_Magazine_30Rnd_762_AK"), "CUP_Stinger_M"};
    respawnMagazines[] = {mag_4("TACU_Magazine_30Rnd_762_AK"), "CUP_Stinger_M"};
};
...
class CUP_I_GUE_Medic: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_4("TACU_Magazine_30Rnd_762_AK"), mag_2("SmokeShell")};
    respawnMagazines[] = {mag_4("TACU_Magazine_30Rnd_762_AK"), mag_2("SmokeShell")};
};
...
class CUP_I_GUE_Soldier_AA2: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_4("TACU_Magazine_30Rnd_762_AK"), "CUP_Strela_2_M"};
    respawnMagazines[] = {mag_4("TACU_Magazine_30Rnd_762_AK"), "CUP_Strela_2_M"};
};
...
class CUP_I_GUE_Sniper: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_6("TACU_Magazine_10Rnd_VS121"), mag_2("HandGrenade"), mag_2("SmokeShell")};
    respawnMagazines[] = {mag_6("TACU_Magazine_10Rnd_VS121"), mag_2("HandGrenade"), mag_2("SmokeShell")};
};
...
class CUP_I_GUE_Commander: CUP_Creatures_Military_NAPA_Soldier_Base {
    magazines[] = {mag_3("TACU_Magazine_30Rnd_545_AK"), mag_2("TACU_Magazine_10Rnd_Makarov")};
    respawnMagazines[] = {mag_3("TACU_Magazine_30Rnd_545_AK"), mag_2("TACU_Magazine_10Rnd_Makarov")};
};
class CUP_I_GUE_Local: CUP_Creatures_Military_NAPA_Civilian_Base {
    magazines[] = {mag_3("TACU_Magazine_30Rnd_762_AK")};
    respawnMagazines[] = {mag_3("TACU_Magazine_30Rnd_762_AK")};
};
