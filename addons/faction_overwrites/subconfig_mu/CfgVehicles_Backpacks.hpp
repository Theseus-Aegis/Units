...
class B_MU_RUSP_Carryall_blk_A: B_MU_Carryall_blk {
    class TransportMagazines {
        ...
        MACRO_ADDMAGAZINE(TACU_Magazine_75Rnd_762_AK,2);
    };
};
class B_MU_IS_Carryall_cbr_A: B_Carryall_cbr {
    class TransportMagazines {
        ...
        MACRO_ADDMAGAZINE(TACU_Magazine_30Rnd_762_AK,10);
...
class B_MU_Mil_AssaultPack_cbr_AR: B_AssaultPack_cbr {
    class TransportMagazines {
        ...
        MACRO_ADDMAGAZINE(TACU_Magazine_100Rnd_QBZ,3);
        MACRO_ADDMAGAZINE(TACU_Magazine_30Rnd_QBZ,3);
    };
};
...
class B_MU_Mil_FieldPack_cbr_GL: B_FieldPack_cbr {
    class TransportMagazines {
        ...
        delete _xx_30Rnd_556x45_Stanag;
        MACRO_ADDMAGAZINE(TACU_Magazine_30Rnd_STANAG,5);
...
class B_MU_LIVP_Carryall_oli_A: B_Carryall_oli {
    class TransportMagazines {
        ...
        MACRO_ADDMAGAZINE(TACU_Magazine_75Rnd_762_AK,2);
        MACRO_ADDMAGAZINE(TACU_Magazine_30Rnd_545_AK,2);
    };
};
