...
class CUP_I_TK_GUE_Soldier_M16A2: CUP_I_TKG_Man_02 {
    scope = 1;
    //magazines[] = {mag_4("tacgt_AI_30Rnd_556x45_STANAG")};
    //respawnMagazines[] = {mag_4("tacgt_AI_30Rnd_556x45_STANAG")};
};
class CUP_I_TK_GUE_Soldier_GL: CUP_I_TKG_Man_12 {
    scope = 1;
    //magazines[] = {mag_4("tacgt_AI_30Rnd_556x45_STANAG"), mag_4("1Rnd_HE_Grenade_shell")};
    //respawnMagazines[] = {mag_4("tacgt_AI_30Rnd_556x45_STANAG"), mag_4("1Rnd_HE_Grenade_shell")};
};
...
class CUP_I_TK_GUE_Soldier_HAT: CUP_I_TKG_Man_01 {
    scope = 1;
    //magazines[] = {mag_4("tacgt_AI_30Rnd_556x45_STANAG"), "CUP_Dragon_EP1_M"};
    //respawnMagazines[] = {mag_4("tacgt_AI_30Rnd_556x45_STANAG"), "CUP_Dragon_EP1_M"};
};
class CUP_I_TK_GUE_Soldier_LAT: CUP_I_TKG_Man_01 {
    scope = 1;
    //magazines[] = {mag_4("tacgt_AI_30Rnd_762x39_AK"), "CUP_RPG18_M"};
    //respawnMagazines[] = {mag_4("tacgt_AI_30Rnd_762x39_AK"), "CUP_RPG18_M"};
};
...
class CUP_I_TK_GUE_Soldier_AR: CUP_I_TKG_Man_03 {
    ...
    //respawnMagazines[] = {mag_3("tacgt_AI_60Rnd_545x39_AK")};
};
