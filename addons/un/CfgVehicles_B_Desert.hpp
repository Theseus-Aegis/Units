...
class TACU_UN_Desert_U_B_Squadleader: TACU_UN_Autumn_U_B_Squadleader {
    editorSubcategory = "TACU_UN_Desert";
    uniformClass = "U_lxWS_UN_Camo2";
    //EDITORPREVIEW(TACU_UN_Desert_U_B_Squadleader);
};
...
class TACU_UN_Desert_U_B_MGAsst: TACU_UN_Autumn_U_B_MGAsst {
    editorSubcategory = "TACU_UN_Desert";
    uniformClass = "U_lxWS_UN_Camo2";
    //EDITORPREVIEW(TACU_UN_Desert_U_B_MGAsst);
};
