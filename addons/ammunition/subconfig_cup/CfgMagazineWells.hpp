class CfgMagazineWells {
    ...
    class TACU_9x19_TEC9 {
        TACU_cup_ai[] = {"TACU_Magazine_32Rnd_TEC9"};
    };

    class CBA_9x19_UZI {
        TACU_cup_ai[] = {"TACU_Magazine_32Rnd_UZI", "TACU_Magazine_72Rnd_UZI"};
    };

    class CBA_9x19_Vityaz {
        TACU_cup_ai[] = {"TACU_Magazine_30Rnd_Vityaz"};
    };

    class CBA_9x39_VSS {
        TACU_cup_ai[] = {"TACU_Magazine_30Rnd_SR3M"};
    };

    class CBA_545x39_AK {
        TACU_cup_ai[] = {"TACU_Magazine_60Rnd_545_AK"};
    };

    class CBA_545x39_RPK {
        TACU_cup_ai[] = {"TACU_Magazine_45Rnd_545_AK"};
    };

    class CBA_556x45_AK {
        TACU_cup_ai[] = {"TACU_Magazine_30Rnd_556_AK"};
    };
    ...
    class CBA_556x45_FAMAS {
        TACU_cup_ai[] = {"TACU_Magazine_25Rnd_556_Famas"};
    };

    class CBA_545x39_Fort {
        TACU_cup_ai[] = {"TACU_Magazine_30Rnd_556_Fort"};
    };

    class CBA_556x45_Minimi {
        TACU_cup_ai[] = {"TACU_Magazine_200Rnd_556_Pouch"};
    };

    class CBA_762x39_RPK {
        TACU_cup_ai[] = {"TACU_Magazine_40Rnd_762_AK"};
    };

    class TACU_762x39_CZ {
        TACU_cup_ai[] = {"TACU_Magazine_30Rnd_762_CZ"};
    };

    class CBA_762x39_VZ58 {
        TACU_cup_ai[] = {"TACU_Magazine_30Rnd_762_SA58"};
    };

    class CBA_762x51_FAL {
        TACU_cup_ai[] = {"TACU_Magazine_20Rnd_762_FAL"};
    };

    class CBA_762x51_LINKS {
        TACU_cup_ai[] = {"TACU_Magazine_100Rnd_762_M240"};
    };
