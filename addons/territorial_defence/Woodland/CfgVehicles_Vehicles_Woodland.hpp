...
class TACU_Territorial_Militia_V_O_Kamaz_ZU23_Woodland;
class TACU_Territorial_Defence_V_O_Kamaz_ZU23_Woodland: TACU_Territorial_Militia_V_O_Kamaz_ZU23_Woodland {
    MACRO_WOODLAND_VEHICLES;
};

class TACU_Territorial_Militia_V_O_GAZ_233011_Woodland;
class TACU_Territorial_Defence_V_O_GAZ_233011_Woodland: TACU_Territorial_Militia_V_O_GAZ_233011_Woodland {
    MACRO_WOODLAND_VEHICLES;
};
class TACU_Territorial_Defence_V_O_GAZ_233144_KORD_Woodland: TACU_Territorial_Defence_V_O_GAZ_233144_KORD_Arid {
    MACRO_WOODLAND_VEHICLES;
...
class TACU_Territorial_Defence_V_O_Mi8_Woodland: TACU_Territorial_Militia_V_O_Mi8_Woodland {
    editorSubcategory = "TACU_Territorial_Defence_EdSubCat_Helicopters_Woodland";
...
class TACU_Territorial_Defence_V_O_Mi8_MTV3_Woodland: TACU_Territorial_Defence_V_O_Mi8_MTV3_Arid {
    editorSubcategory = "TACU_Territorial_Defence_EdSubCat_Helicopters_Woodland";
    crew = "TACU_Territorial_Defence_U_O_Pilot_Woodland";
    typicalCargo[] = {"TACU_Territorial_Defence_U_O_Pilot_Woodland"};
