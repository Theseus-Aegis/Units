...
class TACU_Vanguard_V_I_MK6_Winter: TACU_Vanguard_V_I_MK6_Green {
    editorSubcategory = "TACU_Vanguard_EdSubCat_Turrets_Winter";
    crew = "TACU_Vanguard_U_I_Contractor_Winter_Rifleman_01";
...
class TACU_Vanguard_V_I_HMG_Winter: TACU_Vanguard_V_I_HMG_Green {
    editorSubcategory = "TACU_Vanguard_EdSubCat_Turrets_Winter";
    crew = "TACU_Vanguard_U_I_Contractor_Winter_Rifleman_01";
    typicalCargo[] = {"TACU_Vanguard_U_I_Contractor_Winter_Rifleman_01"};
};
