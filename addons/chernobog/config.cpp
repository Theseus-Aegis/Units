...
class CfgPatches {
    class ADDON {
        ...
        units[] = {
            ...
            "TACU_Chernobog_Sons_M113A1",
            "TACU_Chernobog_Sons_V_I_BRDM2",
            "TACU_Chernobog_Sons_V_I_BTR60",
            "TACU_Chernobog_Sons_V_I_MTLB",
            "TACU_Chernobog_Sons_V_I_T55",
            "TACU_Chernobog_Sons_V_I_Leopard1",
            "TACU_Chernobog_Children_V_I_UAZ",
            "TACU_Chernobog_Children_V_I_UAZ_DSHKM",
            "TACU_Chernobog_Children_V_I_Skoda",
            "TACU_Chernobog_Children_V_I_Ural",
            "TACU_Chernobog_Chosen_V_I_UAZ",
            "TACU_Chernobog_Chosen_V_I_UAZ_DSHKM",
            "TACU_Chernobog_Chosen_V_I_Skoda",
            "TACU_Chernobog_Chosen_V_I_Ural",
            "TACU_Chernobog_Sons_V_I_UAZ",
            "TACU_Chernobog_Sons_V_I_UAZ_DSHKM",
            "TACU_Chernobog_Sons_V_I_Skoda",
            "TACU_Chernobog_Sons_V_I_Ural",
            "TACU_Chernobog_Children_V_I_Hilux",
            "TACU_Chernobog_Children_V_I_Hilux_Armored",
            "TACU_Chernobog_Chosen_V_I_Hilux",
            "TACU_Chernobog_Chosen_V_I_Hilux_Armored",
            "TACU_Chernobog_Chosen_V_I_Hilux_BMP1",
