...
class CfgPatches {
    class ADDON {
        ...
        units[] = {
            ...
            "TACU_Taliban_Veterans_V_I_BRDM2",
            "TACU_Taliban_Veterans_V_I_Hilux",
            "TACU_Taliban_Veterans_V_I_Hilux_Armored",
            "TACU_Taliban_Veterans_V_I_Hilux_BMP",
            "TACU_Taliban_Veterans_V_I_Hilux_BMP_Armored",
            "TACU_Taliban_Veterans_V_I_T72",
            // Turrets - Independent
            ...
            "TACU_Taliban_Veterans_V_O_BRDM2",
            "TACU_Taliban_Veterans_V_O_Hilux",
            "TACU_Taliban_Veterans_V_O_Hilux_Armored",
            "TACU_Taliban_Veterans_V_O_Hilux_BMP",
            "TACU_Taliban_Veterans_V_O_Hilux_BMP_Armored",
            "TACU_Taliban_Veterans_V_O_T72",
            // Turrets - Opfor
