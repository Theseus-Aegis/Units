...
class TACU_Police_U_I_CT_Rifleman: TACU_Main_U_INDEP_Soldier_Base {
    ...
    weapons[] = {"TACU_Police_W_SG551LB_TAC", "hlc_pistol_P226US", "Throw", "Put"};
    respawnWeapons[] = {"TACU_Police_W_SG551LB_TAC", "hlc_pistol_P226US", "Throw", "Put"};
    magazines[] = {mag_6("hlc_30Rnd_556x45_EPR_sg550"), mag_3("hlc_15Rnd_9x19_B_P226"), mag_2("ACE_M84"), "MiniGrenade", "SmokeShell"};
    respawnMagazines[] = {mag_6("hlc_30Rnd_556x45_EPR_sg550"), mag_3("hlc_15Rnd_9x19_B_P226"), mag_2("ACE_M84"), "MiniGrenade", "SmokeShell"};
    headgearList[] = {
...
class TACU_Police_U_I_CT_Breacher: TACU_Police_U_I_CT_Rifleman {
    ...
    weapons[] = {"bnae_m97_virtual", "hlc_pistol_P226US", "Throw", "Put"};
    respawnWeapons[] = {"bnae_m97_virtual", "hlc_pistol_P226US", "Throw", "Put"};
    magazines[] = {mag_8("6Rnd_00_Buckshot_Magazine"), mag_3("hlc_15Rnd_9x19_B_P226"), mag_2("ACE_M84"), "MiniGrenade", "SmokeShell"};
    respawnMagazines[] = {mag_8("6Rnd_00_Buckshot_Magazine"), mag_3("hlc_15Rnd_9x19_B_P226"), mag_2("ACE_M84"), "MiniGrenade", "SmokeShell"};
};

class TACU_Police_U_I_CT_Marksman: TACU_Police_U_I_CT_Rifleman {
    displayName = "Marksman";
    editorPreview = QPATHTOF(ui\Police_U_I_CT_Marksman.jpg);
    weapons[] = {"TACU_Police_W_SG5501_DMR_Rail", "hlc_pistol_P226US", "Throw", "Put"};
    respawnWeapons[] = {"TACU_Police_W_SG5501_DMR_Rail", "hlc_pistol_P226US", "Throw", "Put"};
    magazines[] = {mag_6("hlc_30Rnd_556x45_EPR_sg550"), mag_3("hlc_15Rnd_9x19_B_P226")};
    respawnMagazines[] = {mag_6("hlc_30Rnd_556x45_EPR_sg550"), mag_3("hlc_15Rnd_9x19_B_P226")};
};
...
class TACU_Police_U_I_Enforcer_Rifleman: TACU_Main_U_INDEP_Soldier_Base {
    ...
    respawnWeapons[] = {"CUP_arifle_G36C", "hlc_pistol_P226US", "Throw", "Put"};
...
class TACU_Police_U_I_Enforcer_SMG_1: TACU_Police_U_I_Enforcer_Rifleman {
    ...
    weapons[] = {"hgun_PDW2000_F", "hlc_pistol_P226US", "Throw", "Put"};
    respawnWeapons[] = {"hgun_PDW2000_F", "hlc_pistol_P226US", "Throw", "Put"};
    magazines[] = {mag_6("30Rnd_9x21_Mag"), mag_3("hlc_15Rnd_9x19_B_P226")};
    respawnMagazines[] = {mag_6("30Rnd_9x21_Mag"), mag_3("hlc_15Rnd_9x19_B_P226")};
};
...
class TACU_Police_U_I_Enforcer_SMG_2: TACU_Police_U_I_Enforcer_Rifleman {
    ...
    weapons[] = {"SMG_03C_black", "hlc_pistol_P226US", "Throw", "Put"};
    respawnWeapons[] = {"SMG_03C_black", "hlc_pistol_P226US", "Throw", "Put"};
    magazines[] = {mag_4("50Rnd_570x28_SMG_03"), mag_3("hlc_15Rnd_9x19_B_P226")};
    respawnMagazines[] = {mag_4("50Rnd_570x28_SMG_03"), mag_3("hlc_15Rnd_9x19_B_P226")};
};
...
class TACU_Police_U_I_Enforcer_Breacher: TACU_Police_U_I_Enforcer_Rifleman {
    ...
    weapons[] = {"bnae_m97_virtual", "hlc_pistol_P226US", "Throw", "Put"};
    respawnWeapons[] = {"bnae_m97_virtual", "hlc_pistol_P226US", "Throw", "Put"};
    magazines[] = {mag_6("6Rnd_00_Buckshot_Magazine"), mag_3("hlc_15Rnd_9x19_B_P226")};
    respawnMagazines[] = {mag_6("6Rnd_00_Buckshot_Magazine"), mag_3("hlc_15Rnd_9x19_B_P226")};
};
